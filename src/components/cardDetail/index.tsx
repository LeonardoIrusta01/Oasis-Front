	...
	return (
		<>
			<div className='w-full flex justify-center flex-col bg-oasisGradient-antiFlashWhite h-screen'>
				...
				<div
					id='modal-container'
					className='relative bottom-10 mx-5 h-48 md:h-72 align-bottom bg-oasisGradient-cambridgeBlue text-left overflow-hidden shadow-xl sm:my-8 sm:align-middle sm:max-w-lg w-screen/90'>
					<div
						id='modal-wrapper'
								...
								<button onClick={incrementCount}>
									<svg
										...
										<g
											...
											strokeLinejoin='round'
											stroke='#CCCCCC'
											strokeWidth='0.8960000000000001'></g>
										<g id='SVGRepo_iconCarrier'>
											{' '}
