        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="bg-oasisGradient-seaGreen shadow w-full rounded-md divide-y divide-gray-200">
            <div className="px-3 py-3">
              <div>
                <label className="font-semibold text-sm text-oasisGradient-antiFlashWhite pb-1 py-2 block">
                  Nombre
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="font-semibold text-sm text-oasisGradient-antiFlashWhite pb-1 block">
                  Contraseña
                </label>
                <input
                  type="password"
